...
#    train_x, test_x, train_y, test_y = train_test_split(df.drop('Delayed',
#    axis=1),df['Delayed'], test_size=0.2, random_state=42)
...
#        try:
#            departure_date_time_parsed =
#            datetime.strptime(departure_date_time, '%d/%m/%Y %H:%M:%S')
